...
class NetworkModule(private val configuration: NetworkConfiguration) {
    ...
    fun providesOkHttpClient(
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor {
                ...
                val newRequest = request.newBuilder().header("Authorization", "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")
    ...
    fun providesRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            ...
            .addCallAdapterFactory(RxThreadCallAdapter(configuration.ioScheduler(), configuration.mainThreadScheduler()))
            .client(okHttpClient)
            .build()
    }
}
